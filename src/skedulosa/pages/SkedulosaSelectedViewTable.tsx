...
import {
  formatShortWordDate,
  formatNumericDate,
} from '@/afda/pages/utils/afdaUtils';
...
const SkedulosaSelectedViewTable = () => {
  ...
  const createdDate = SkedulosaSelectedViewTable
    ...
    : null;
  const createdStr = createdDate ? formatShortWordDate(createdDate) : '—';
  const createdSmallStr = createdDate
    ? formatNumericDate(createdDate)
    : undefined;
