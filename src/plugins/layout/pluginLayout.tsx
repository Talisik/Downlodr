...
import DropdownBar from '@/downlodr/components/base/DropDownbar';
...
const PluginLayout = () => {
  return (
    <div className="h-screen flex flex-col bg-white dark:bg-darkMode text-gray-900 dark:text-gray-100">
      ...
      <div className="bg-nav-main dark:bg-darkMode border-b-2 border-gray-200 dark:border-darkModeCompliment">
