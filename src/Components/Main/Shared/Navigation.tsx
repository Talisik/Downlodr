    ...
    >
              ...
              <NavLink
                ...
                className={({ isActive }) =>
                  `${collapsed ? 'p-2 ' : 'nav-link '} ${
                    isActive ? 'bg-gray-100 dark:bg-[#3E3E46]' : ''
                  } dark:text-gray-200 dark:hover:bg-[#3E3E46] flex ${
                    collapsed
            ...
            <div className="ml-2 space-y-1 mt-1">
              <NavLink
                ...
                className={({ isActive }) =>
                  `nav-link ${
                    isActive ? 'bg-gray-100 dark:bg-[#3E3E46]' : ''
                  } dark:text-gray-200 dark:hover:bg-[#3E3E46]`
                }
              >
      ...
      >
        <button
          ...
          className={`flex items-center justify-center w-10 h-10 rounded-full bg-white dark:bg-gray-800 shadow-md hover:bg-gray-100 dark:hover:bg-[#3E3E46] dark:text-gray-200 border border-gray-200 dark:border-gray-700`}
