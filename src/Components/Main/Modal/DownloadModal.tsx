      ...
      >
        ...
        <div className="bg-[#FEF9F4] dark:bg-darkMode flex gap-3 justify-end -mx-6 px-4 py-3 rounded-b-md">
          <Button
            onClick={handleClose}
            variant="outline"
            className="h-8 px-2 py-0.5 hover:bg-[#f9fafb] hover:text-black rounded-md dark:border-darkModeCompliment dark:bg-darkModeCompliment dark:text-darkModeLight dark:hover:bg-darkModeHover dark:hover:text-white font-medium"
          >
            Cancel
          </Button>
          <Button
