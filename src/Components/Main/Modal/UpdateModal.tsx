 ...
 * @returns JSX.Element - The rendered component displaying an UpdateModal
 */
...
const UpdateModal: React.FC<UpdateModalProps> = ({ isOpen, onClose }) => {
  ...
  */
  ...
  return (
    ...
    >
      <div className="bg-white dark:bg-darkModeDropdown border border-gray-200 dark:border-gray-700 rounded-lg pt-5 pr-6 pl-6 pb-3 max-w-xl w-full mx-4 max-h-[100vh] overflow-y-auto">
        {/* Header */}
        ...
        <form onSubmit={(e) => e.preventDefault()}>
          ...
          <div className="space-y-2 text-sm">
            <div className="flex items-center gap-2 mb-2">
              <label className="block dark:text-gray-200 text-nowrap font-bold text-sm">
                Version Management
              </label>
          ...
          {/* YTDLP Binary Management Section - Commented out for now */}
          {/*
