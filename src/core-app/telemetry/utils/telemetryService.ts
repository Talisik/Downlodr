...
export function toAnyValue(value: unknown): AnyValue | null {
...
export function toKeyValueList(attributes: Record<string, unknown>): KeyValue[] {
...
export function toUnixNano(isoTimestamp: string): string {
