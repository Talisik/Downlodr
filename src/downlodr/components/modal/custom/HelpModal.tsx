              ...
              <div className="space-y-4">
                ...
                <div className="border dark:border-gray-700 rounded-lg overflow-hidden">
                  <AccordionSection
                    ...
                    content={
                      <ul className="list-disc pl-6 space-y-3 dark:text-gray-300 text-xs">
                        <li>{t('helpModal.subscription.whatHappensAfter.s1')}</li>
                        <li>{t('helpModal.subscription.whatHappensAfter.s2')}</li>
                        <li>{t('helpModal.subscription.whatHappensAfter.s3')}</li>
                        <li>{t('helpModal.subscription.whatHappensAfter.s4')}</li>
                        <li>{t('helpModal.subscription.whatHappensAfter.s5')}</li>
                        <li>{t('helpModal.subscription.whatHappensAfter.s6')}</li>
                      </ul>
                    }
                  />
                </div>
                ...
                <div className="border dark:border-gray-700 rounded-lg overflow-hidden">
                  <AccordionSection
                    ...
                    content={
                      <ul className="list-disc pl-6 space-y-3 dark:text-gray-300 text-xs">
                        <li>
                          <strong>{t('helpModal.subscription.commonErrors.invalidUrl.title')}</strong>
                          <ul className="list-inside list-disc pl-4 space-y-1 mt-1 dark:text-gray-300 text-xs">
                            <li>{t('helpModal.subscription.commonErrors.invalidUrl.s1')}</li>
                            <li>{t('helpModal.subscription.commonErrors.invalidUrl.s2')}</li>
                          </ul>
                        </li>
                        <li>
                          <strong>{t('helpModal.subscription.commonErrors.unsupportedPlatform.title')}</strong>
                          <ul className="list-inside list-disc pl-4 space-y-1 mt-1 dark:text-gray-300 text-xs">
                            <li>{t('helpModal.subscription.commonErrors.unsupportedPlatform.s1')}</li>
                            <li>{t('helpModal.subscription.commonErrors.unsupportedPlatform.s2')}</li>
                          </ul>
                        </li>
                        <li>
                          <strong>{t('helpModal.subscription.commonErrors.videoOrShorts.title')}</strong>
                          <ul className="list-inside list-disc pl-4 space-y-1 mt-1 dark:text-gray-300 text-xs">
                            <li>{t('helpModal.subscription.commonErrors.videoOrShorts.s1')}</li>
                            <li>{t('helpModal.subscription.commonErrors.videoOrShorts.s2')}</li>
                            <li>{t('helpModal.subscription.commonErrors.videoOrShorts.s3')}</li>
                          </ul>
                        </li>
                        <li>
                          <strong>{t('helpModal.subscription.commonErrors.alreadySubscribed.title')}</strong>
                          <ul className="list-inside list-disc pl-4 space-y-1 mt-1 dark:text-gray-300 text-xs">
                            <li>{t('helpModal.subscription.commonErrors.alreadySubscribed.s1')}</li>
                            <li>{t('helpModal.subscription.commonErrors.alreadySubscribed.s2')}</li>
                          </ul>
                        </li>
                        <li>
                          <strong>{t('helpModal.subscription.commonErrors.noVideos.title')}</strong>
                          <ul className="list-inside list-disc pl-4 space-y-1 mt-1 dark:text-gray-300 text-xs">
                            <li>{t('helpModal.subscription.commonErrors.noVideos.s1')}</li>
                            <li>{t('helpModal.subscription.commonErrors.noVideos.s2')}</li>
                          </ul>
                        </li>
                        <li>
                          <strong>{t('helpModal.subscription.commonErrors.analysisFailed.title')}</strong>
                          <ul className="list-inside list-disc pl-4 space-y-1 mt-1 dark:text-gray-300 text-xs">
                            <li>{t('helpModal.subscription.commonErrors.analysisFailed.s1')}</li>
                            <li>{t('helpModal.subscription.commonErrors.analysisFailed.s2')}</li>
                            <li>{t('helpModal.subscription.commonErrors.analysisFailed.s3')}</li>
                          </ul>
                        </li>
                      </ul>
                    }
