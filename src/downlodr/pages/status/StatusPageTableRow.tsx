                      ...
                      <div className="space-y-1 text-xs">
                        {hiddenColumnIds.includes('status') && (
                          <div className="flex gap-4 justify-between">
                            ...
                            <span className="font-medium capitalize">{download.status}</span>
                          </div>
                        )}
                        {hiddenColumnIds.includes('size') && (
                          <div className="flex gap-4 justify-between">
                            <span className="text-gray-400">Size</span>
                            <span className="font-medium">{formatFileSize(download.size)}</span>
                          </div>
                        )}
                        {hiddenColumnIds.includes('format') && (
                          <div className="flex gap-4 justify-between">
                            <span className="text-gray-400">Format</span>
                            <span className="font-medium">{download.ext || download.audioExt || '—'}</span>
                          </div>
                        )}
