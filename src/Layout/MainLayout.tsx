  ...
  return (
    <ErrorBoundary>
      <div className="h-screen flex flex-col bg-white dark:bg-darkMode text-gray-900 dark:text-gray-100">
        <TitleBar className="h-10 p-2 bg-titleBar dark:bg-[#1F2937] border-b-2 border-gray-200 dark:border-componentBorder" />
        <DropdownBar className="h-11 pl-4 bg-nav-main dark:bg-darkMode border-b-2 border-gray-200 dark:border-componentBorder" />
        <TaskBar className="py-[8px] pr-[24px] pl-[8px] bg-nav-main dark:bg-darkMode border-b-2 border-gray-200 dark:border-componentBorder" />
