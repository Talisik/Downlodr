...
interface DemoVideoPlayerModalProps {
  video: DummyVideo | null;
  onClose: () => void;
}

const DemoVideoPlayerModal: React.FC<DemoVideoPlayerModalProps> = ({ video, onClose }) => {
  ...
  return (
    ...
    >
      <div
        className="relative bg-white dark:bg-darkModeTable rounded-xl overflow-hidden shadow-2xl flex flex-col w-[960px] max-w-[96vw] h-[560px] max-h-[90vh]"
            ...
            <div className="flex flex-col gap-2 p-4 h-full overflow-hidden">
              ...
              <div className="border-t border-gray-200 dark:border-gray-700 pt-2 flex-shrink-0">
                ...
                <div className="flex flex-wrap gap-1">
                  ...
                  {DUMMY_TAGS.map((t) => (
                    <span key={t} className="px-1.5 py-0.5 text-[10px] rounded bg-primary/10 text-primary">
                      {t}
                    </span>
                  ))}
                </div>
...
export default DemoVideoPlayerModal;
